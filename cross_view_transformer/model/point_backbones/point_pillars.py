...
class Backbone(nn.Module):
    def __init__(self, in_channel, out_channels, layer_nums, layer_strides):
        super().__init__()
...
class PointPillars(nn.Module):
    def __init__(self,
                 ...
                 point_cloud_range=[-50.0, -50.0, -2.0, 50.0, 50.0, 6.0],
                 max_num_points=32,
        ...
        self.to_decoder =  nn.Conv2d(512, 256, 1)
    ...
    def forward(self, batch):
        ...
        xs = self.backbone(pillar_features)[-1]
        
        y = self.decoder(self.to_decoder(xs))
        z = self.to_logits(y)
